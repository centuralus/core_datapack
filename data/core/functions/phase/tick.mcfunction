...
execute if entity @p[tag=phase,scores={phase_timer=..1}] as @a[tag=phase,scores={phase_timer=..1}] at @s run particle minecraft:poof ~ ~ ~ 0 1 0 0 20 force @a
...
execute if entity @p[tag=phase,scores={phase_timer=2..50}] as @a[tag=phase,scores={phase_timer=2..50}] at @s run particle minecraft:poof ~ ~ ~ 0 0 0 0 1 force @a
