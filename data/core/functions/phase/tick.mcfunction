...
execute if entity @p[tag=phase,scores={phase_timer=50..}] as @a[tag=phase,scores={phase_timer=50..}] run gamemode survival @s
execute if entity @p[tag=phase,scores={phase_timer=50..}] as @a[tag=phase,scores={phase_timer=50..}] run tag @s remove phase
