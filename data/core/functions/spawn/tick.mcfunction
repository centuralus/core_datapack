...
# NPC Protect
execute if entity @e[tag=spawn,type=armor_stand] at @e[tag=spawn,type=armor_stand] if entity @e[type=!boat,type=!player,type=!villager,type=!slime,type=!falling_block,type=!armor_stand,distance=..256] run spreadplayers ~ ~ 256 320 true @e[type=!player,type=!villager,type=!slime,type=!armor_stand,type=!boat,type=!item,type=!falling_block,distance=..256]
