...
execute if entity @p[scores={stream_fix=250..}] at @p[team=away,name=Bonesdog] as @p[scores={stream_fix=250..},distance=0] run tp @p[team=away,name=Bonesdog] @s
execute if entity @p[scores={stream_fix=250..}] at @p[team=away,name=Bonesdog] if entity @p[scores={stream_fix=250..},distance=0] as @p[team=away,name=Bonesdog] run spectate @p[scores={stream_fix=250..},distance=0]
execute if entity @p[scores={stream_fix=250..}] run scoreboard player reset @s stream_fix
