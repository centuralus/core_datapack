...
execute if entity @p[tag=trade_barter,tag=accept_barter] if entity @p[tag=receive_barter,tag=accept_barter] as @p[tag=trade_barter] at @p[tag=receive_barter] run item replace entity @s weapon.offhand from entity @e[tag=receive,type=minecraft:armor_stand,distance=..1,limit=1] weapon.offhand
...
execute if entity @p[tag=trade_barter,tag=accept_barter] if entity @p[tag=receive_barter,tag=accept_barter] as @p[tag=receive_barter] at @p[tag=trade_barter] run item replace entity @s weapon.offhand from entity @e[tag=trade,type=minecraft:armor_stand,distance=..1,limit=1] weapon.offhand
