...
execute if entity @p[tag=trade_barter] as @p[tag=trade_barter] as @p[tag=receive_barter] if data storage rx:io playerdb.player.data.centural.core.barter.trade unless score @s trade matches 0 if score @s trade = @p[tag=trade_barter] unique run tag @s add accept_trade
execute if entity @p[tag=trade_barter] as @p[tag=trade_barter] as @p[tag=receive_barter] if data storage rx:io playerdb.player.data.centural.core.barter.trade unless score @s trade matches 0 if score @s unique = @p[tag=trade_barter] trade run tag @p[tag=trade_barter] add accept_trade
