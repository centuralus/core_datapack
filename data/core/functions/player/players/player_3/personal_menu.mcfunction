...
execute if entity @s[tag=!personal_menu_show_symbol,tag=personal_menu_show_text] run function core:player/players/player_3/personal_menu_show_text
execute if entity @s[tag=personal_menu_show_symbol,tag=!personal_menu_show_text] run function core:player/players/player_3/personal_menu_show_symbol
...
execute if entity @p[tag=player_3_menu,team=!player_3] as @a[tag=player_3_menu,team=!player_3] run tellraw @s ["",{"text":"Player Menu"}]
