...
#
execute if entity @p[tag=player_3_menu,team=!player_3] as @a[tag=player_3_menu,team=!player_3] run tellraw @s ["",{"text":"[ Teleport To ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 3"}}]
