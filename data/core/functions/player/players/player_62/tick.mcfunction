...
#
execute if entity @p[tag=player_62_menu,team=!player_62] as @a[tag=player_62_menu,team=!player_62] run tellraw @s ["",{"text":"[ Teleport To ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 62"}}]
