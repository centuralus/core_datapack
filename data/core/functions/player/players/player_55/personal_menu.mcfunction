...
execute if entity @s[tag=!personal_menu_show_symbol,tag=personal_menu_show_text] run function core:player/players/player_55/personal_menu_show_text
execute if entity @s[tag=personal_menu_show_symbol,tag=!personal_menu_show_text] run function core:player/players/player_55/personal_menu_show_symbol
...
execute if entity @p[tag=player_55_menu,team=!player_55] as @a[tag=player_55_menu,team=!player_55] run tellraw @s ["",{"text":"Player Menu"}]
