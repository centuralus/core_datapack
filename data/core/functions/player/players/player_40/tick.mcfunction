...
#
execute if entity @p[tag=player_40_menu,team=!player_40] as @a[tag=player_40_menu,team=!player_40] run tellraw @s ["",{"text":"[ Teleport To ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 40"}}]
