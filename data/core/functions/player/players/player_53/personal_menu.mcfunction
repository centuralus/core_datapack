...
execute if entity @s[tag=!personal_menu_show_symbol,tag=personal_menu_show_text] run function core:player/players/player_53/personal_menu_show_text
execute if entity @s[tag=personal_menu_show_symbol,tag=!personal_menu_show_text] run function core:player/players/player_53/personal_menu_show_symbol
...
execute if entity @p[tag=player_53_menu,team=!player_53] as @a[tag=player_53_menu,team=!player_53] run tellraw @s ["",{"text":"Player Menu"}]
