...
#
execute if entity @p[tag=player_31_menu,team=!player_31] as @a[tag=player_31_menu,team=!player_31] run tellraw @s ["",{"text":"[ Teleport To ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 31"}}]
