...
execute if entity @s[tag=!personal_menu_show_symbol,tag=personal_menu_show_text] run function core:player/players/player_17/personal_menu_show_text
execute if entity @s[tag=personal_menu_show_symbol,tag=!personal_menu_show_text] run function core:player/players/player_17/personal_menu_show_symbol
...
execute if entity @p[tag=player_17_menu,team=!player_17] as @a[tag=player_17_menu,team=!player_17] run tellraw @s ["",{"text":"Player Menu"}]
