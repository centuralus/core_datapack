...
#
execute if entity @p[tag=player_56_menu,team=!player_56] as @a[tag=player_56_menu,team=!player_56] run tellraw @s ["",{"text":"[ Teleport To ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 56"}}]
