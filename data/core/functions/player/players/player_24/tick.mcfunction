...
#
execute if entity @p[tag=player_24_menu,team=!player_24] as @a[tag=player_24_menu,team=!player_24] run tellraw @s ["",{"text":"[ Teleport To ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 24"}}]
