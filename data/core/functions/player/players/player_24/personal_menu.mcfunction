...
execute if entity @s[tag=!personal_menu_show_symbol,tag=personal_menu_show_text] run function core:player/players/player_24/personal_menu_show_text
execute if entity @s[tag=personal_menu_show_symbol,tag=!personal_menu_show_text] run function core:player/players/player_24/personal_menu_show_symbol
...
execute if entity @p[tag=player_24_menu,team=!player_24] as @a[tag=player_24_menu,team=!player_24] run tellraw @s ["",{"text":"Player Menu"}]
