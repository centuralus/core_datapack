...
#
execute if entity @p[tag=player_57_menu,team=!player_57] as @a[tag=player_57_menu,team=!player_57] run tellraw @s ["",{"text":"[ Teleport To ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 57"}}]
