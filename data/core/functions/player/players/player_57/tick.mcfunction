...
execute if entity @s[team=player_57,scores={prefix=2..18}] run scoreboard players operation @s prefix_storage = @s prefix
...
execute if entity @s[team=player_57,scores={prefix=18}] run team modify player_57 prefix ["",{"text":"❦","color":"#149414","clickEvent":{"action":"run_command","value":"/trigger player_57_menu set 1"}}]
