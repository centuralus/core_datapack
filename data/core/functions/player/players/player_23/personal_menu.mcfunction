...
execute if entity @s[tag=!personal_menu_show_symbol,tag=personal_menu_show_text] run function core:player/players/player_23/personal_menu_show_text
execute if entity @s[tag=personal_menu_show_symbol,tag=!personal_menu_show_text] run function core:player/players/player_23/personal_menu_show_symbol
...
execute if entity @p[tag=player_23_menu,team=!player_23] as @a[tag=player_23_menu,team=!player_23] run tellraw @s ["",{"text":"Player Menu"}]
