...
#
execute if entity @p[tag=player_41_menu,team=!player_41] as @a[tag=player_41_menu,team=!player_41] run tellraw @s ["",{"text":"[ Teleport To ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 41"}}]
