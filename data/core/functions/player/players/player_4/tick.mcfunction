...
execute if entity @s[team=player_4,scores={prefix=2..18}] run scoreboard players operation @s prefix_storage = @s prefix
...
execute if entity @s[team=player_4,scores={prefix=18}] run team modify player_4 prefix ["",{"text":"❦","color":"#149414","clickEvent":{"action":"run_command","value":"/trigger player_4_menu set 1"}}]
...
#
execute if entity @p[tag=player_4_menu,team=!player_4] as @a[tag=player_4_menu,team=!player_4] run tellraw @s ["",{"text":"[ Teleport To ","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 4"}},{"selector":"@p[scores={teleport_unique=4}]","clickEvent":{"action":"run_command","value":"/trigger teleport set 4"}},{"text":" ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 4"}}]
