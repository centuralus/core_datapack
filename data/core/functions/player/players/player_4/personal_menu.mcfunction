...
execute if entity @s[tag=!personal_menu_show_symbol,tag=personal_menu_show_text] run function core:player/players/player_4/personal_menu_show_text
execute if entity @s[tag=personal_menu_show_symbol,tag=!personal_menu_show_text] run function core:player/players/player_4/personal_menu_show_symbol
...
execute if entity @p[tag=player_4_menu,team=!player_4] as @a[tag=player_4_menu,team=!player_4] run tellraw @s ["",{"text":"Player Menu"}]
