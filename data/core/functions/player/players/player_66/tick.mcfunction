...
#
execute if entity @p[tag=player_66_menu,team=!player_66] as @a[tag=player_66_menu,team=!player_66] run tellraw @s ["",{"text":"[ Teleport To ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 66"}}]
