...
execute if entity @s[team=player_2,tag=personal_menu_show_spawn] at @s run summon armor_stand ~ ~ ~ {Team:"spawn_text",Tags:["personal_menu_show_spawn"],CustomName:'{"text":""}'}

execute if entity @s[team=player_2,tag=personal_menu_show_wild] at @s run summon armor_stand ~ ~ ~ {Team:"wild_text",Tags:["personal_menu_show_wild"],CustomName:'{"text":""}'}

execute if entity @s[team=player_2] at @s run summon armor_stand ~ ~ ~ {Team:"settings_text",Tags:["personal_menu_show_settings"],CustomName:'{"text":""}'}
...
execute at @s run tellraw @s[team=player_2] [{"selector":"@e[tag=personal_menu_show_spawn,type=armor_stand,limit=1]"},{"selector":"@e[tag=personal_menu_show_wild,type=armor_stand,limit=1]"},{"selector":"@e[tag=personal_menu_show_settings,type=armor_stand,limit=1]"}]
