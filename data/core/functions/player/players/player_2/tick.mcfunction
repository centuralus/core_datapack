...
#Start Prefix
execute if entity @s[team=player_2,scores={prefix=2}] as @a[team=player_2,scores={prefix=2}] run 
team modify player_2 prefix ["",{"text":"🔥","color":"#F7630C","clickEvent":{"action":"run_command","value":"/trigger player_2_menu set 1"}}]
execute if entity @s[team=player_2,scores={prefix=3}] as @a[team=player_2,scores={prefix=3}] run 
