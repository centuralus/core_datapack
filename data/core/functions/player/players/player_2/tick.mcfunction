...
execute if entity @s[team=player_2,scores={prefix=2..18}] run scoreboard players operation @s prefix_storage = @s prefix
...
execute if entity @s[team=player_2,scores={prefix=18}] run team modify player_2 prefix ["",{"text":"❦","color":"#149414","clickEvent":{"action":"run_command","value":"/trigger player_2_menu set 1"}}]
...
#
execute if entity @p[tag=player_2_menu,team=!player_2] as @a[tag=player_2_menu,team=!player_2] run tellraw @s ["",{"text":"[ Teleport To ","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 2"}},{"selector":"@p[scores={teleport_unique=2}]","clickEvent":{"action":"run_command","value":"/trigger teleport set 2"}},{"text":" ]","color":"#10B3C9","clickEvent":{"action":"run_command","value":"/trigger teleport set 2"}}]
