...
execute if entity @p[scores={prefix_storage=11,buff_timer=500..},scores={sneak_timer=1..20}] as @a[scores={prefix_storage=11,buff_timer=500..},scores={sneak_timer=1..20}] at @s anchored eyes run particle end_rod ^ ^ ^5 0 0 0 0.01 20 force
