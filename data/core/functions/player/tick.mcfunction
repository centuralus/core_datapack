...
execute if entity @p[scores={prefix_storage=16,buff_timer=0..160}] as @a[scores={prefix_storage=16,buff_timer=0..160}] at @s positioned ~ ~1 ~ run function core:animate/defence_buff/animate
