...
scoreboard objectives add settings_text trigger ["",{"text":"[Settings]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger settings set 1"}},{"text":"[Show Spawn]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger settings set 1"}},{"text":"[Hide Spawn]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger settings set -1"}},{"text":"[Show Wild]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger settings set 2"}},{"text":"[Hide Wild]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger settings set -2"}},{"text":"[Show Teleport]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger settings set 3"}},{"text":"[Hide Teleport]","color":"gray","clickEvent":{"action":"run_command","value":"/trigger settings set -3"}}]
